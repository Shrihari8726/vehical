...
let HomeComponent = class HomeComponent {
    constructor(router) {
        ...
        this.links = [
            {
                name: "Customer Form", url: "/customer"
            }, {
                name: "Vehical Form", url: "/customer"
            }, {
                name: "Vendor Form", url: "/vendor"
            }, {
                name: "Driver Form", url: "/customer"
            }, {
                name: "Consignment Form", url: "/customer"
            }, {
                name: "Trip Form", url: "/customer"
            }
        ];
    }
    ngOnInit() {
